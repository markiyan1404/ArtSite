...
setTimeout((): void => localStorage.setItem("typePaintingAnim", "paintingToPainting"), 700);
...
$("*").on("touchend", (): void => {
    ...
    if (startingX - 100 > movingX && checkPhone && navWindowDisplay === "none" && windowWidth < 1000) {
        bottomArrowClick("swipeRight", "paintingToPainting swipeRightLoad", "arrow__next-page-name", rightArrow());
    }
});