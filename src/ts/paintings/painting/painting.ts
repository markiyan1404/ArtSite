import "originSCSS/paintings/painting/painting.scss";
import "originSCSS/paintings/painting/adap/adap-painting.scss";
...
import(`origin/content/paintings/painting/${key}.json`).then(langJSON => {
...
$(".description__link").on("click", function (): void {
    ...
    setTimeout((): string => location.href = "./paintings_author.html#" + activeAuthor, 500);
});
