import "originSCSS/sculptures/sculpture/sculpture.scss";
import "originSCSS/sculptures/sculpture/adap/adap-sculpture.scss";
...
import(`origin/content/sculptures/sculpture/${key}.json`).then(langJSON => {
...
$(".description__link").on("click", function (): void {
    if ($(this).hasClass("mouse-active")) {
        ...
        setTimeout((): string => location.href = "./sculptures_author.html#" + activeAuthor, 500);
    }
});
